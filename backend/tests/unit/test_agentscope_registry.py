...
async def test_execute_runs_all_phases(
    mock_debate, mock_fanout, mock_formatter, mock_model, mock_toolkit,
):
    ...
    # Mock the agent __call__ for phase 4 (sequential)
    ...
    with patch.object(registry, "_resolve_market_data") as mock_market:
        ...
        with patch.object(registry, "_resolve_provider_config") as mock_config:
            ...
            # Patch ALL_AGENT_FACTORIES to return mock agents
    ...
    # Verify steps were recorded (db.add called for each agent)
